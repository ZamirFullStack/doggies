...
if (!isset($_SESSION['codigo_validado']) || !isset($_SESSION['correo_recuperacion'])) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (strlen($nueva) < 8) {
    ...
    if ($stmt->execute([$hash, $correo])) {
      $exito = 'Contraseña actualizada con éxito. Ya puedes iniciar sesión.';
      unset($_SESSION['codigo_verificacion'], $_SESSION['correo_recuperacion'], $_SESSION['codigo_validado']);
    } else {
